...
setjmp:
    ...
    mov     rax, qword [rsp]        ; return address
    mov     qword [rdi+8*7],    rax

    mov     rsi, 0                  ; If set == NULL, old := current signalmask
    lea     rdx, [rdi+8*8]          ; old = mask
...
longjmp:
    ...
    pop     rax
    mov     rax, qword [rdi+8*7]    ; return address
    push    rax
